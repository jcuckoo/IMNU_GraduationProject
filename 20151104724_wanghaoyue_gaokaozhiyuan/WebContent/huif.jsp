...
var ajax = new AJAX();
ajax.post("/gkzyfzxt/gkzyfzxt?ac=gethouses&louno="+louno);
...
<%
 ...
 %>
<form action="/gkzyfzxt/huif.jsp?id=<%=id %>&f=f" name="f1" method="post" >
...
%>
alert("操作成功");
parent.location.replace("/gkzyfzxt/admin/sysuser.jsp");
<%}%>
</script>
