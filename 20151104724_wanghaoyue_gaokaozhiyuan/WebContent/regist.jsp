...
<body style="background-image:url('<%=request.getContextPath()%>/img/11.jpg');background-size:100% 100%;">
<!--header开始-->
	<div class="header">
		<div class="logo">
			<a href="user/regist" class="logo">注册账号</a>
		</div>
		<div class="login">
			<span>我已注册，现在就</span> <a href="user/login" class="login_icon">登录</a>
		</div>
		<div class="hr"></div>
	</div>
	<!--header结束-->
				...
				<dl>
					...
					<dd class="ipt_box pro">
						<input id="agree" type="checkbox" checked /> <span>阅读并接受<a
							href="agreement.jsp">《XX用户协议》</a></span>
					</dd>
				</dl>
				<dl>
					<dt></dt>
