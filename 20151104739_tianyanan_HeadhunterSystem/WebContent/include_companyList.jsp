...
<%@ page import="com.qst.itoffer.dao.CompanyDAO,com.qst.itoffer.bean.Company,com.qst.itoffer.bean.Job" %>
...
<meta content="易职专注于为企业提供高效的人力资源解决方案，同时面向IT类技术人才推出快速一站式免费就业服务。秉承QST青软实训人才服务理念，为数千家企业量身定做个性化、全程化的人才培养体系，同时帮助中高级人才铺设成功之路，为人才和企业架设起沟通之桥。" name="description">
      ...
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            ...
            <img src="recruit/images/${company.companyPic}" width="990"> </a> </div>
            <!-- 招聘职位展示 -->
