			...
			<div class="box">
				<div class="box_1">
					<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
						...
						<div class="blank"></div>
						<form action="index/addHouse.action" name="myform" method="post">
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">房屋名称：</td>
									<td align="left" bgcolor="#FFFFFF"><input name="housename" type="text" size="25" class="inputBg" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="left" bgcolor="#FFFFFF"><input name="price" type="text" size="25" class="inputBg" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="left" bgcolor="#FFFFFF"><input name="mianji" type="text" size="25" class="inputBg" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">楼层：</td>
									<td align="left" bgcolor="#FFFFFF"><input name="louceng" type="text" size="25" class="inputBg" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">朝向：</td>
									<td align="left" bgcolor="#FFFFFF"><input name="chaoxiang" type="text" size="25" class="inputBg" /></td>
								</tr>
								<tr>
