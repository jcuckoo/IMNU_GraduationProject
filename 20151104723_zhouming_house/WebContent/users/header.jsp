		...
		<div class="top_nav">
			<div class="block">
				<div class="header_r">
					...
					<c:if test="${sessionScope.userid != null }">
						<font id="ECS_MEMBERZONE"> 欢迎光临本站${sessionScope.username }， <a href="index/usercenter.action">[用户中心]</a>&nbsp;
		...
		<div class="header_top logo_wrap clearfix">
			...
			<div class="ser_n">
				<form id="searchForm" class="searchBox" name="searchForm" method="post" action="index/query.action">
					<input name="name" type="text" id="keyword" value="" class="searchKey" /> <input type="submit"
...
<div class="menu_box clearfix">
	<div class="block">
		<div class="menu">
			<a href="index.jsp" class="cur">首页</a> <a href="index/article.action" class="cur">新闻公告</a>
			<c:forEach items="${cateList}" var="cate">
				<a href="index/cate.action?id=${cate.cateid }" class="cur">${cate.catename }</a>
			</c:forEach>
			<a href="index/all.action" class="cur">全部房源</a> <a href="index/bbs.action" class="cur">留言交流</a>
		</div>
	</div>
</div>