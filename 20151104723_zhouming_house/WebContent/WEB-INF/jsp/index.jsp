...
<title>房屋租赁系统后台管理平台</title>
</head>
	<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
		<frame src="top" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame noresize src="left" scrolling="yes" /> 
			<frame noresize name="right" src="right" scrolling="yes" /> 
		</frameset>
		<frame noresize name="status_bar" scrolling="no" src="bottom" />
	</frameset>
	<noframes>
		<body>
