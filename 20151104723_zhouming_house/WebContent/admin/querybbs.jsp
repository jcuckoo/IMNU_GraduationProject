		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="4" cellspacing="1"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">留言交流信息列表</td>
					</tr>
					<tr align="center">
						...
						<td align="center" bgcolor="#ebf0f7">回复数</td>
					</tr>
					<c:forEach items="${bbsList}" var="bbs">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center">${bbs.username}</td>
							<td align="center">${bbs.title}</td>
							<td align="center">${bbs.addtime}</td>
							<td align="center">${bbs.hits}</td>
							<td align="center">${bbs.repnum}</td>
						</tr>
					</c:forEach>
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="bbs/queryBbsByCond.action" name="myform" method="post">
								查询条件<select name="cond" style="width: 100px"><option value="usersid">按用户查询</option>
									...
									<option value="repnum">按回复数查询</option></select>关键字<input type="text" name="name" style="width: 100px" /><input
