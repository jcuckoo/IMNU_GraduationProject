		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="4" cellspacing="1"
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="rebbs/queryRebbsByCond.action" name="myform" method="post">
								查询条件<select name="cond" style="width: 100px"><option value="usersid">按用户查询</option>
									...
									<option value="addtime">按回复日期查询</option></select>关键字<input type="text" name="name" style="width: 100px" /><input
