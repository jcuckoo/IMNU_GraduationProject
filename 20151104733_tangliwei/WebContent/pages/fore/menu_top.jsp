      	...
      	<div class="navbar-collapse collapse">
			...
			<c:if test="${not empty currentUser }">
		        <ul class="nav navbar-nav navbar-right">
		          	<li class="dropdown">
		            	<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i>&nbsp;${currentUser.truename }&nbsp;<span class="glyphicon glyphicon-chevron-down"></span></a>
