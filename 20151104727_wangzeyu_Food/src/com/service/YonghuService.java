...
public class YonghuService {
	...
	public List queryYonghus(Yonghu record,String yonghuName,int page,int rows, String sdate, String edate) {
		// TODO Auto-generated method stub
		return yonghuDao.getYonghuList(record,yonghuName,page,rows,sdate,edate);
	}
