		...
		<table class="table table-bordered" id="message-table">
			...
			<tbody>
				...
				<tr class="message-tr" id="table-tr-${status.index}" data-role="item" >
					...
					<td>${var.mobile }</td>
					<td>
					    <a href="javascript:void();" data-url="${ctx}/manage/company/edit.do?id=${var.id}"
							data-toggle="modal" data-target="#modal" class="btn btn-info btn-sm">
							<i class="glyphicon glyphicon-edit"></i> 编辑
						</a>&nbsp;&nbsp;
						<a href="javascript:" data-url="${ctx}/manage/company/delete.do?id=${var.id}" 
							data-role="item-delete" data-name="公司信息" class="btn btn-warning btn-sm">
