				...
				<div class="col-md-12" id="rigthContextDiv">
					<div class="page-header clearfix" style="margin-top: 15px;">
						<h1 class="pull-left" style="margin-bottom: 4px; font-size: 18px;">
							<span class="glyphicon glyphicon-home"></span> 首页 &gt; 保单信息管理
						</h1>
					</div>
					...
					<div class="well well-sm">
						<div class="form-inline">
							<div class="form-group">
								<input type="text" id="search_number" class="form-control" placeholder="保单编号">
							</div>
							<div class="form-group">
								<input type="text" id="search_insuranceName" class="form-control" placeholder="保险名称">
							</div>
							<c:if test="${currentUser.userRole.name eq '管理员' }">
								<div class="form-group">
									<input type="text" id="search_userName" class="form-control" placeholder="投保人姓名">
								</div>
							</c:if>
