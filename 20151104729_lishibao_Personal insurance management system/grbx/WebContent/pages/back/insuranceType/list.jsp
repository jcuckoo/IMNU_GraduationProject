...
<script type="text/javascript">
	var Query = "${ctx}/manage/insuranceType/contextlist.do";
</script>
</head>
<body>
	<!-- 头部begin -->
				...
				<div class="col-md-12" id="rigthContextDiv">
					<div class="page-header clearfix" style="margin-top: 15px;">
						<h1 class="pull-left" style="margin-bottom: 4px; font-size: 18px;">
							<span class="glyphicon glyphicon-home"></span> 首页 &gt; 保险类别管理
						</h1>
						<div class="pull-right">
							<a class="btn btn-primary btn-sm" href="javascript:void();" data-url="${ctx }/manage/insuranceType/edit.do" 
					...
					<div class="well well-sm">
						<div class="form-inline">
							<div class="form-group">
								<input type="text" id="search_name" class="form-control" placeholder="保险类别名称">
							</div>
	...
	<script>app.controller='insuranceType/list';</script>
</body>
</html>